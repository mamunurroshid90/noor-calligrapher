                ...
                <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-200 hover:shadow-2xl transition-all duration-300">
                  ...
                  <div style={{ fontFamily: banglaFont }} className="space-y-4">
                    ...
                    <button
                      onClick={() =>
                        window.open(
                          "https://wa.me/8801688262501?text=হ্যালো!%20আমি%20ক্যালিগ্রাফি%20পেইন্টিং%20কোর্সে%20ভর্তি%20হতে%20চাই।%20নতুন%20বছরের%2025%%20ডিসকাউন্ট%20অফার%20সম্পর্কে%20জানতে%20চাই।",
                          "_blank"
                        )
                      }
                      style={{ fontFamily: banglaFont }}
